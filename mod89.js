...
let replaced = ts.replace(/<div class="item">\s*<span>Devoluciones:<\/span>[\s\S]*?TOTAL ESPERADO \(EF\):<\/span>\s*<span>\$\$\{Number\(data\.totalTeoricoFisico \|\| 0\)\.toFixed\(2\)\}<\/span>\s*<\/div>/, replacement);
